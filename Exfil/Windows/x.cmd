...
REM if Exist %USERPROFILE%\Desktop (
REM xcopy /C /Q /G /Y %USERPROFILE%\Desktop\*.pdf %dst% >>nul
REM xcopy /C /Q /G /Y %USERPROFILE%\Desktop\*.docx %dst% >>nul
REM )

REM if Exist %USERPROFILE%\Downloads (
REM xcopy /C /Q /G /Y %USERPROFILE%\Downloads\*.pdf %dst% >>nul
REM xcopy /C /Q /G /Y %USERPROFILE%\Downloads\*.docx %dst% >>nul
REM )
